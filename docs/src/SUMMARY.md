...
- [Session 6: Training a neural network](./session-6.md)
- [Session 7: Multiplier design](./session-7.md)
- [Session 8: Architecture and datapath](./session-8.md)
- [Session 9: Convolution engine](./session-9.md)
- [Session 10: Communication protocols](./session-10.md)
